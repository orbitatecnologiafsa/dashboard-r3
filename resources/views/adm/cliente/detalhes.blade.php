...
@section('conteudo')
    <div class="container-fluid py-4" style="bottom: 100px;">
        ...
        <form method="post" action="{{ route('adm-atualizar-cliente-put' ,$users->id) }}">
            @csrf
            @method('PUT')
            <div class="card" style="margin-top: 100px;">
                <div class="card-header pb-0 p-3">
                    <div class="d-flex justify-content-between">
                        <h6 class="mb-2">Atualizar cliente</h6>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-alternative" type="text" name="nome_filial"
                                    value="{{ $users->nome_filial ?? old('nome_filial') }}" id="example-date-input">
                                @error('nome_filial')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-alternative" type="text" name="cnpj"
                                    value="{{ $users->cnpj ?? old('cnpj')  }}" id="example-date-input">
                                @error('cnpj')
                                    <div class="error " style="color:red">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="col-md-5 pb-0 p-3 me-2">
                    <div class="form-group">
                        <button class=" btn btn-primary  active" type="submit">Atualizar</button>
                    </div>
                </div>
