...
<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main" style="height: auto;">
  <div class="sidenav-header">
    ...
    <a class="navbar-brand m-0" href="{{ route('adm-cadastro-cliente')}}">
      <img src="https://orbitadashboard.azurewebsites.net/img/orbita-icon.png')}}" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <div class="collapse navbar-collapse w-auto h-auto ps" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class=" nav-link @yield('ativo-cadastro')" href="{{ route('adm-cadastro-cliente')}}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-chart-bar-32 text-primary text-sm opacity-10"></i>
          </div>
          <span class="nav-link-text ms-1">Cadastrar cliente</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link @yield('ativo-lista')" href="{{ route('adm-lista-cliente') }}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link @yield('ativo-lista-loja')" href="{{ route('adm-lista-loja') }}">
          <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
            <i class="ni ni-tv-2 text-primary text-sm opacity-10"></i>
          </div>
